...
var app = express();
const { insertwolfPackNFT, removewolfPackNFT } = require('../functions/function_wolfpack');
...
app.post('/filter', async function(req, res){	
  ...
  let result = await filterwolfNFT(attack, defense, gender, level, breed, tokenId, askingPrice, id);
